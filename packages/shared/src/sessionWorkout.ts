...
export function createSessionWorkoutItem(
  input: Partial<SessionWorkoutItem> &
...
export function parseSessionWorkoutMetadata(
  input: unknown,
): SessionWorkoutMetadata {
  ...
  return {
    ...
    selectedPlanName:
      typeof values.selectedPlanName === "string"
