  ...
  public: {
    Tables: {
      ...
      workout_plan_exercise: {
        ...
        Relationships: [
          {
            foreignKeyName: "workout_plan_exercise_plan_id_fkey";
            columns: ["plan_id"];
            isOneToOne: false;
      ...
      workout_plan_session: {
        ...
        Relationships: [
          {
            foreignKeyName: "workout_plan_session_plan_id_fkey";
            columns: ["plan_id"];
            isOneToOne: false;
            referencedRelation: "workout_plan";
            referencedColumns: ["id"];
      ...
      workout_template_exercise: {
        ...
        Relationships: [
          {
            foreignKeyName: "workout_template_exercise_template_id_fkey";
            columns: ["template_id"];
            isOneToOne: false;
