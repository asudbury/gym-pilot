export const dataSchemaDocs = {
  ...
  plans: {
    description: "Workout plans used as templates",
    type: "Plan",
    fields: [
      { name: "id", type: "string", required: true },
  ...
  assignments: {
    description:
      "User-specific assignment copies that reference a plan and own completion state",
    type: "Assignment",
    fields: [
      { name: "id", type: "string", required: true },
  ...
  users: {
    ...
    fields: [
      ...
      {
        name: "role",
        type: "admin | trainer | client | guest",
        required: true,
      },
    ],
  },
...
export const dataSchemaSummary = [
  {
    entity: "Exercise",
    purpose:
      "Stores the public exercise catalogue used by the home and exercise detail views.",
  },
  {
    entity: "Plan",
  ...
  },
  {
    entity: "Assignment",
    purpose:
      "Stores user-specific assignment copies that reference a plan and own completion state.",
  },
  {
    entity: "User roles",
