...
interface SignInResponse {
  data?: {
    user: any // Replace 'any' with actual User type from Supabase if available
    session: any // Replace 'any' with actual Session type from Supabase if available
  }
...
export async function handleEdgeFunctionSignIn(
  ...
  try {
    ...
    logger.error('[AuthService] Edge Function sign-in failed:', err.message)
