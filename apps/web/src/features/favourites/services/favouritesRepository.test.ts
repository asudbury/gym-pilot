...
describe('favourites repository', () => {
  ...
  it('reuses the same repository instance so repeated saves can be deduped', () => {
    const firstRepository = createFavouritesRepository()
    const secondRepository = createFavouritesRepository()
