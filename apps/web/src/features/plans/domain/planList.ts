...
export function resolvePlanListViewModels(plans: Plan[]): PlanListCardViewModel[] {
...
export function resolveAssignmentListViewModels(assignments: Assignment[]): PlanListCardViewModel[] {
  return assignments.map((assignment) => ({
    id: assignment.id,
    title: assignment.assignmentName || 'Untitled assignment',
    subtitle: assignment.assignedUserName ? `Assigned to ${assignment.assignedUserName}` : 'No user assigned',
