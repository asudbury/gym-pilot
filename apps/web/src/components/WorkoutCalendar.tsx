    ...
    if (view === 'month') {
      ...
      if (dailyData) {
        switch (dailyData.linkState) {
          case 'no-link':
            classes.push('has-no-link-workouts')
            break
          case 'unassigned':
            classes.push('has-unassigned-workouts')
            break
          case 'linked':
            classes.push('has-linked-workouts')
            break
        }
      } else {
        // Apply a class for days without any workouts
        classes.push('has-no-workouts')
      }

      if (isSelected) {
        classes.push('selected-day-border')
      }
