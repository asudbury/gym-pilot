...
export const toneClasses: Record<ToneName, string> = {
  default: 'cursor-pointer rounded-full bg-slate-100 px-3 py-1 text-sm text-slate-700',
  white: 'cursor-pointer rounded-full bg-white px-3 py-1 text-sm font-medium text-slate-700',
