export const appTokens = {
  ...
  pageShell:
    'min-h-screen w-full bg-[radial-gradient(circle_at_top_left,_rgba(59,130,246,0.12),_transparent_32%),radial-gradient(circle_at_top_right,_rgba(167,139,250,0.12),_transparent_30%),linear-gradient(135deg,_rgba(248,250,252,0.95),_rgba(241,245,249,0.9))] pb-4 pt-0 text-slate-800 transition-colors sm:px-4 sm:py-10 dark:bg-[radial-gradient(circle_at_top_left,_rgba(59,130,246,0.22),_transparent_30%),radial-gradient(circle_at_top_right,_rgba(236,72,153,0.16),_transparent_28%),linear-gradient(135deg,_rgba(2,6,23,0.98),_rgba(15,23,42,0.92))] dark:text-slate-100',
} as const
